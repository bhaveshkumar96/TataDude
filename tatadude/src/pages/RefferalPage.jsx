     ...
     <p style={{textAlign:"start",marginLeft:"30px"}}>UI/UX > Refer & Earn </p>
      <div id="container">
        <div id="cont-1st-div">
          ...
          <button id="wid-button">Withdraw Balance</button>
        </div>
        <div id="cont-2nd-div">
      ...
      <div className="how-does">How does it work ?</div>
      ...
      <div id="how-container">
        <div className="child-div">
          ...
          <div className="textDiv">
            <p className="firstP">Invite your Friends</p>
            <p className="secondP">
        ...
        <div className="child-div">
          ...
          <div className="textDiv">
            <div className="firstP">Invite your Friends</div>
            <div className="secondP">Share the link tutedude.com with your friends</div>
          </div>
        </div>
        <div className="child-div">
          <div className="svgDiv">
